...
export const RELEASE_GATES_V2_EXTENSION = Object.freeze({
  ...
  "terminal-proof-test": Object.freeze({ command: "node", args: Object.freeze(["--test", "tests/subagents-backend-adapter.test.mjs", "tests/subagents-delegation-adapter.test.mjs", "tests/subagents-domain.test.mjs", "tests/subagents-run-coordinator.test.mjs"]), execution: "deterministic", channels: PREVIEW_AND_LATER }),
  "subagent-security-redteam": Object.freeze({ command: "node", args: Object.freeze(["--test", "tests/subagents-approval.test.mjs", "tests/subagents-artifact-writer.test.mjs", "tests/subagents-backend-adapter.test.mjs", "tests/subagents-batch-swarm.test.mjs", "tests/subagents-delegation-adapter.test.mjs", "tests/subagents-protected-evidence.test.mjs", "tests/subagents-run-coordinator.test.mjs", "tests/subagents-swarm-goal.test.mjs"]), execution: "deterministic", channels: PREVIEW_AND_LATER }),
